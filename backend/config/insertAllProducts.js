...
const MONGODB_URI =
  "mongodb+srv://chiltel2024:childev123@cluster0.if0pp.mongodb.net/chiltel?retryWrites=true&w=majority&appName=Cluster0";
...
const insertData = async () => {
  try {
    ...
    console.log(
      `${insertedProducts.length} products inserted successfully into MongoDB!`
    );
