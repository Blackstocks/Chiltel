...
import { TrendingUp, Wallet, CalendarDays, Clock, ArrowUpRight, ArrowDownRight } from 'lucide-react';

const EarningsOverview = ({ profile, currentMonthEarnings, percentageChange }) => {
  return (
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-baseline space-x-2">
                  <span className="text-2xl font-bold text-gray-800">
                    ₹{profile.earning.reduce((total, e) => total + e.amount, 0) || 0}
                  </span>
                </div>
              </div>
