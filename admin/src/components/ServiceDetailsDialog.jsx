					...
					<Card>
						...
						<CardContent className="space-y-3">
							<div className="grid grid-cols-2 gap-2">
								<div>
									<p className="text-sm font-medium">Service Names:</p>
									<p className="text-sm">
										{service.services.map((s) => s.serviceId.name).join(", ")}
									</p>
								</div>
								<div>
								...
								<div>
									...
									<p className="text-sm">
										{service.services
											.map((s) => s.serviceId.estimatedDuration)
											.join(", ")}
									</p>
								</div>
							</div>
							...
							<div>
								...
								<ul className="list-disc pl-4 mt-1">
									{service.services.map((s) =>
										s.serviceId.requirements.map((req, index) => (
